...
kable(step4_mr_proteins_table) %>% kable_styling(bootstrap_options = "condensed", full_width = T, position="left")
```
...
step4_mr_res_table %>% mutate_if(is.numeric, format, scientific=F, digits=3) %>% kable %>% kable_styling(bootstrap_options = "condensed", full_width = T, position="left")
```
