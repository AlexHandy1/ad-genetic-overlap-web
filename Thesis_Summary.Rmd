...
step2_target_sample_summary <- read_sheet("https://docs.google.com/spreadsheets/d/1JwJrrme5_OUVt4GRcbNJ71m2rK7KR-L6HF-gHeKNiK0/edit#gid=0", sheet = "Table2_Step2_Target_Sample")
...
```{r message=FALSE, warning=FALSE, echo=FALSE}
step3_target_sample_summary <- read_sheet("https://docs.google.com/spreadsheets/d/1JwJrrme5_OUVt4GRcbNJ71m2rK7KR-L6HF-gHeKNiK0/edit#gid=0", sheet = "Step3_Target_Sample")
...
1. Interleukin-10 (IL10.2773.50.2) - p = 0.0392
2. Haptoglobin (HP.3054.3.2) - p = 0.0460

Variance explained (R^2) was low for each protein (IL10.2773.50.2 R^2 = 0.0104, HP.3054.3.2 R^2 = 0.00974) **[TO BE VERIFIED]**.  
